...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  inputs.forEach(function (input) {
    if (!input.closest('div').querySelector('label')) {
  ...
  // temp
  var viewBoxes = document.querySelectorAll('.delivery-box');
  if (viewBoxes.length) {
    viewBoxes.forEach(function (viewBoxxxx) {
...
/******/ })()
;
//# sourceMappingURL=main.35806698cd8c0940f9fc.js.map