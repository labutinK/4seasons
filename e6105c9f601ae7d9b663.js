...
document.addEventListener("DOMContentLoaded", function (event) {
  formSubmit('[data-form-reg1]', document.getElementById('registration-approve'), function () {
    formSubmit('[data-form-reg-approve]', document.getElementById('reg-success'));
  });
  formSubmit('[data-form-reg2]', document.getElementById('registration-approve'), function () {
    formSubmit('[data-form-reg-approve]', document.getElementById('reg-success'));
  });
  formSubmit('[data-form-recovery]', document.getElementById('recovery-success'), function () {});
  formSubmit('[data-form-auth]', document.getElementById('login-success'), function () {});
  formSubmit('[data-form-profile]', null, function () {
    var resultBox = document.querySelector('.form-body__results');
  ...
  //way 1
  new Modal('bdbd2').setAdditionalLogicAfterSubmit(function (wrapper) {
    formSubmit('[data-form="new-manager"]', document.getElementById('managerAdded'), function () {});
  });
  ...
  new Modal('new-address').setAdditionalLogicAfterSubmit(function (wrapper) {
    var map = wrapper.querySelector('#modal-map');
    if (map) {
      ymaps.ready(initManagerMap);
    }
    formSubmit('[data-form="new-address"]', document.getElementById('addressSuccess'), function () {});
  });
